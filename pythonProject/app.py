...
def getvalue():
    ...
    def bitcoin():
        df = pd.read_csv(r"C:\Users\Admin\Desktop\BTC-USD (7).csv")
        ...
        df.to_csv(r"C:\Users\Admin\Desktop\BTC-USD (7).csv", index=False)
    ...
    def eth():
        ...
        df = pd.concat([df, new_data], ignore_index=True)
        df.to_csv("C:/Users/HP/Downloads/ETH-USD.csv", index=False)
    ...
    def usdt():
        ...
        df=pd.concat([df,new_data],ignore_index=True)
        df.to_csv("C:/Users/HP/Downloads/USDT-USD.csv",index=False)
        return prediction
